  ...
  return (
    <main className="p-6 lg:p-8">
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <Link href="/adorador/mural" className="bg-white p-5 rounded-xl shadow hover:shadow-md transition">
        ...
        <Link href="/adorador/oracao" className="bg-white p-5 rounded-xl shadow hover:shadow-md transition">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <section className="bg-white rounded-xl shadow p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/adorador/mural" className="text-sm text-blue-600 hover:underline">Ver todos</Link>
          </div>
        ...
        <section className="bg-white rounded-xl shadow p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/eventos" className="text-sm text-blue-600 hover:underline">Ver todos</Link>
          </div>
                ...
                <li key={evento.id} className="flex gap-3 items-start">
                  <div className="bg-blue-50 text-blue-700 rounded-lg p-2 text-center min-w-[48px]">
                    <p className="text-xs font-medium leading-none">
                      {parseLocalDate(evento.data_inicio).toLocaleDateString('pt-BR', { day: '2-digit', month: 'short' })}
                    </p>
                  </div>
                  <div>
        ...
        <section className="bg-white rounded-xl shadow p-6 lg:col-span-2">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/estudos" className="text-sm text-blue-600 hover:underline">Ver todos</Link>
          </div>
            ...
            <ul className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {ultimosEstudos.map((estudo) => (
                <li key={estudo.id} className="border border-gray-100 rounded-lg p-4">
                  <p className="text-xs text-purple-600 font-medium uppercase tracking-wide mb-1">{estudo.categoria}</p>
