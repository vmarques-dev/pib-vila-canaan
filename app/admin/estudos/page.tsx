...
export default function EstudosPage() {
  ...
  const [confirmDelete, setConfirmDelete] = useState<Estudo | null>(null)
  ...
  const handleArchive = async (id: string, arquivado: boolean) => {
    ...
    if (error) {
      ...
      toast.success(arquivado ? 'Estudo reativado com sucesso!' : 'Estudo concluído com sucesso!')
      await fetchItems()
    }
  }
  ...
  return (
    <main className="p-8">
      ...
      <ConfirmDialog
        ...
        message={`Tem certeza que deseja excluir o estudo "${confirmDelete?.titulo}"? Esta ação não pode ser desfeita.`}
        confirmText="Excluir"
        cancelText="Cancelar"
        variant="danger"
