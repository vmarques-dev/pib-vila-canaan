    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="font-semibold text-lg text-gray-900 mb-1">E-mail</h3>
            <p className="text-gray-600">{info?.email || 'contato@pibvilacanaa.com.br'}</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="font-semibold text-lg text-gray-900 mb-1">Horários</h3>
            <p className="text-gray-600 whitespace-pre-line">
