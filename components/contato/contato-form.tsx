            ...
            <div>
              ...
              <div className="relative">
                <select
                  {...register('assunto')}
                  id="assunto"
                  className={`w-full appearance-none px-4 pr-10 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white ${
                    errors.assunto ? 'border-red-500' : 'border-gray-300'
                  } ${assuntoValue ? 'text-gray-900' : 'text-gray-400'}`}
                  disabled={loading}
                  defaultValue=""
                >
                  ...
                  <option value="Pastoral / Aconselhamento">Pastoral / Aconselhamento</option>
