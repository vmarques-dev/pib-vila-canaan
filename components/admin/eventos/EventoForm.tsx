...
export function EventoForm({
  ...
  useEffect(() => {
    if (editingItem) {
      ...
      setValue('horario_inicio', editingItem.horario_inicio || '')
      setValue('horario_fim', editingItem.horario_fim || '')
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none ${
              errors.horario_inicio ? 'border-red-500' : ''
            }`}
          />
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none ${
              errors.horario_fim ? 'border-red-500' : ''
            }`}
          />
          {errors.horario_fim && (
